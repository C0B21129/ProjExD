...
def main(winstyle=0):
    ...
    Alien.images = [load_image(im) for im in ("ryunen.png", "ryunen.png", "ryunen.png")]
    Bomb.images = [load_image("taigaku.png")]
    Shot.images = [load_image("tani.png")]
    S_Shot.images = [load_image("joseikin.png")]
    ...
    bgdtile = load_image("koukadai.webp")
    ...
    while player.alive():
        ...
        S_firing = keystate[pg.K_s]
        if not player.reloading and firing and len(shots) < MAX_SHOTS:
            Shot(player.gunpos())
            if pg.mixer:
                shoot_sound.play()
        player.reloading = firing
        if not player.reloading and S_firing and len(shots) < 1:
            S_Shot(player.gunpos())
            if pg.mixer:
                shoot_sound.play()
